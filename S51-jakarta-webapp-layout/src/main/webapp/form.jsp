...
<jsp:include page="layout/header.jsp" />
    ...
    <form action="${pageContext.request.contextPath}/productos/form" method="post">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="date" name="fecha_registro" id="fecha_registro" value="${producto.fechaRegistro != null? producto.fechaRegistro.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")): ""}" class="form-control">
            </div>
        ...
        <div class="row mb-2">
        <div>
            <input class="btn btn-success" type="submit" value="${producto.id !=null && producto.id >0 ? "Editar": "Crear"}">
        </div>
        </div>
