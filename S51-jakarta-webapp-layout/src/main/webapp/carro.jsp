...
<jsp:include page="layout/header.jsp" />
    ...
    <div class="alert alert-warning mb-2">Lo sentimos no hay productos en el carro de compras!</div>
    </c:when>
    <c:otherwise>
    ...
    <div class="my-2">
        <a class="btn btn-sm btn-success" href="${pageContext.request.contextPath}/productos.html">seguir comprando</a>
