<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.*, org.jnavarro.apiservlet.webapp.headers.models.* ,java.time.format.*" %>
<%
    List<Categoria> categorias = (List<Categoria>) request.getAttribute("categorias");
    Map<String,String> errores = (Map<String,String>) request.getAttribute("errores");
    Producto producto = (Producto) request.getAttribute("producto");
    String fecha = producto.getFechaRegistro() !=null ? producto.getFechaRegistro().format(DateTimeFormatter.ofPattern("yyy-MM-dd")): "";
%>
